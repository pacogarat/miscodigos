...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $ocLazyLoadProvider, ASSETS){
	...
	$stateProvider.
		...
		state('app.gastos', {
                        //abstract: true,
			url: '/gastos',
			templateUrl: appHelper.templatePath('gastos/gastos'),
		...
		// Gastos EVO
		state('app.gastos.evo', {
			url: '/evo',
			templateUrl: appHelper.templatePath('gastos/gastos-evo'),
                        controller: 'GastosEvoCtrl',
                        resolve: {
                                resources: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.charts.dxGlobalize,
...
app.constant('ASSETS', {
	...
	'evo': appHelper.assetPath('../app/js/evo-controller.js'),
...
app.constant('config', {
    host: 'http://evo.local/app_dev.php/',
    routes: {
        concept: {
            get: 'http://evo.local/app_dev.php/rest/concept/',
            select2: 'http://evo.local/app_dev.php/rest/concept/select2',
            pie: 'http://evo.local/app_dev.php/rest/concept/pie'
        }
    }
});